        ...
        {title: 'Persiapan Belajar', bab: [
            {
                ...
                subbab: [
                    <>
                        <h1 className="text-2xl mb-4 font-bold">Peralatan yang Dibutuhkan</h1>
                        <p className="mb-4">Sebelum memulai pada pelajaran pemrograman, ada 2 hal yang harus kita siapkan terlebih dahulu. Yaitu Code Editor atau IDE dan Browser</p>
                    </>,
                    <>
                        <h1 className="text-2xl mb-4 font-bold">Code Editor atau IDE</h1>
                    ...
                    <>
                        <h1 className="text-2xl mb-4 font-bold">WebStorm (Jetbrains)</h1>
                    ...
                    <>
                        <h1 className="text-2xl mb-4 font-bold">Visual Studio Code</h1>
                        <div className="flex justify-center">
                            <img
                    ...
                    <>
                        <h1 className="text-2xl mb-4 font-bold">Brackets</h1>
                        <div className="flex justify-center">
                            <img
                    ...
                    <>
                        <h1 className="text-2xl mb-4 font-bold">Web Browser</h1>
                        <p className="mb-4">Dalam mengakses halaman web, user akan membutuhkan web browser. Developer pun memerlukannya untuk melihat hasil website yang dikembangkan. Berikut beberapa web browser dari berbagai vendor yang dapat digunakan.</p>
                    </>,
                    <>
                        <h1 className="text-2xl mb-4 font-bold">Mozilla Firefox</h1>
                        <div className="flex justify-center">
                            <img
                    ...
                    <>
                        <h1 className="text-2xl mb-4 font-bold">Google Chrome</h1>
                        <div className="flex justify-center">
                            <img
